...
import com.liyaan.customizeview.view.StepViewItemDecoration
...
class StepViewFragment:Fragment() {
    ...
    private fun init() {
        ...
        recyclerView.adapter = StepViewAdapter(requireContext(), dataList, timeList)
        recyclerView.addItemDecoration(StepViewItemDecoration(requireContext()))
    }
