...
//                    .transform(BlurTransformation(), GrayscaleTransformation())
        ...
        btnThumbnail.setOnClickListener {
            Glide.with(this).load(IMAGE_URL3)
                .thumbnail(0.25f)
